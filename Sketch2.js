...
function setup (){
   database = firebase.database();
    ...
    form  = new Form();
    back1   = new Button('Back',50,525,'back1');  
    back2  = new Button('Back',250,525,'back2');
    back3 = new Button('Back',1050,525,'back3');
...
function draw (){ 
   ...
   //image(bg,0,100,displayWidth,displayHeight);
    form.display(); 
    ...
    //    showname.html(name);
     //   showname.position(700,350);
      //  showname.style('color','white')
       // showname.show();
        back4.position(1300,525);
        back4.show();
        form.feedback.show();
        form.didyouknow.show();
        form.Explore.show();
        logout.position(900,450);
        logout.show();
